      ...
      function(a, b, c, d) {
        ...
        (m.select = a.select = function(b, c) {
          ...
          (m.removeSlide = function(a) {
            ...
            n.splice(b, 1),
              n.length > 0 && a.active
                ? b >= n.length ? m.select(n[b - 1]) : m.select(n[b])
                : r > b && r--,
    ...
    function(a, b) {
      function c(a, c) {
        return a.currentStyle
          ? a.currentStyle[c]
          : b.getComputedStyle ? b.getComputedStyle(a)[c] : a.style[c];
      }
      function d(a) {
          ...
          angular.forEach(
            ...
            function(c, e) {
              i[c] = angular.isDefined(b[c])
                ? 6 > e ? d(b[c])(a.$parent) : a.$parent.$eval(b[c])
                : g[c];
            }
          ),
                  ...
                  : "down" === a
                    ...
                    : "pageup" === a || "pagedown" === a
                      ...
                      : "home" === a
                        ...
                        : "end" === a &&
                          (c = d(this.activeDate.getFullYear()) + e - 1),
          ...
          d.addClass("modal-backdrop"),
            f.modalInClass &&
              ...
              b.$on(c.NOW_CLOSING_EVENT, function(b, c) {
                var g = c();
                e
                  ? e(d, { removeClass: f.modalInClass })
                      .start()
                      .then(g)
                ...
                h.promise.then(function() {
                  ...
                  g.modalInClass &&
                    ...
                    d.$on(a.NOW_CLOSING_EVENT, function(a, b) {
                      var d = b();
                      e
                        ? e(f, { removeClass: g.modalInClass })
                            .start()
                            .then(d)
          ...
          e ||
            ...
            h.modalInClass &&
              ...
              b.$on(c.NOW_CLOSING_EVENT, function(b, c) {
                var d = c();
                g
                  ? g(f, { removeClass: h.modalInClass })
                      .start()
                      .then(d)
                ...
                j.promise.then(function() {
                  ...
                  i.modalInClass &&
                    ...
                    d.$on(a.NOW_CLOSING_EVENT, function(a, b) {
                      var d = b();
                      g
                        ? g(h, { removeClass: i.modalInClass })
                            .start()
                            .then(d)
          ...
          (b.addTab = function(a) {
            c.push(a),
              1 === c.length && a.active !== !1
                ? (a.active = !0)
                : a.active ? b.select(a) : (a.active = !1);
          }),
