...
angular.module("xeditable", []).value("editableOptions", {
      ...
      return a({
        ...
        render: function() {
          ...
          a.attr(
            ...
            a.attr("on-open-focus", this.attrs.eOnOpenFocus || !0),
            a.attr("ng-readonly", this.attrs.eReadonly || !1),
            this.attrs.eNgChange &&
              (a.attr("ng-change", this.attrs.eNgChange),
              this.inputEl.removeAttr("ng-change")),
            this.attrs.eStyle &&
              (a.attr("style", this.attrs.eStyle),
          ...
          var b = angular.isDefined(this.attrs.eShowCalendarButton)
            ? this.attrs.eShowCalendarButton
            : "true";
          if ("true" === b) {
            var c = angular.element(
                '<button type="button" class="btn btn-default"><i class="glyphicon glyphicon-calendar"></i></button>'
              ),
              d = angular.element('<span class="input-group-btn"></span>');
            c.attr("ng-click", this.attrs.eNgClick),
              d.append(c),
              this.inputEl.append(d);
          } else a.attr("ng-click", this.attrs.eNgClick);
        ...
        render: function() {
          this.parent.render.call(this),
            this.attrs.eTitle &&
              ...
              this.inputEl
                .parent()
                .append("<span>" + this.attrs.eTitle + "</span>"));
        },
        autosubmit: function() {
          var a = this;
      ...
      return a({
        ...
        render: function() {
          ...
          var a = b(this.attrs.eNgOptions),
            ...
            d = "";
          this.attrs.eNgChange &&
            (c = ' ng-change="' + this.attrs.eNgChange + '"'),
            this.attrs.eChecklistComparator &&
              (d =
  ...
  (function() {
    ...
    angular.forEach(b, function(b) {
      var c = a("editable-" + b);
      angular.module("xeditable").directive(c, [
        "editableDirectiveFactory",
        function(a) {
          return a({
            directiveName: c,
            ...
            render: function() {
              if (
                (this.parent.render.call(this),
                this.attrs.eInputgroupleft || this.attrs.eInputgroupright)
              ) {
                if (
                  (this.inputEl.wrap('<div class="input-group"></div>'),
                  this.attrs.eInputgroupleft)
                ) {
                  var a = angular.element(
  ...
  angular.module("xeditable").directive("editableTagsInput", [
    "editableDirectiveFactory",
    "editableUtils",
    function(a, b) {
      var c = a({
          ...
          render: function() {
            this.parent.render.call(this),
              this.inputEl.append(
                b.rename("auto-complete", this.attrs.$autoCompleteElement)
              ),
              this.inputEl.removeAttr("ng-model"),
        ...
        d = c.link;
      return (
        (c.link = function(a, b, c, e) {
          var f = b.find("editable-tags-input-auto-complete");
          return (
            (c.$autoCompleteElement = f.clone()), f.remove(), d(a, b, c, e)
          );
        }),
        c
      );
      ...
      return a({
        ...
        render: function() {
          ...
          var a = b(this.attrs.eNgOptions),
            d = "";
          this.attrs.eNgChange &&
            (d = 'ng-change="' + this.attrs.eNgChange + '"');
          var e =
      ...
      return a({
        ...
        render: function() {
          if ((this.parent.render.call(this), this.attrs.ePlaceholder)) {
            var a = angular.element(
              '<option value="">' + this.attrs.ePlaceholder + "</option>"
            );
    ...
    function(a, b) {
      var c = a({
          ...
          render: function() {
            this.parent.render.call(this),
              this.inputEl.append(
                b.rename("ui-select-match", this.attrs.$matchElement)
              ),
              this.inputEl.append(
                b.rename("ui-select-choices", this.attrs.$choicesElement)
              ),
              this.inputEl.removeAttr("ng-model"),
      ...
      return (
        (c.link = function(a, b, c, e) {
          ...
          return (
            (c.$matchElement = f.clone()),
            (c.$choicesElement = g.clone()),
            f.remove(),
            g.remove(),
            d(a, b, c, e)
          );
    ...
    function(a, b) {
      function c(a, c, d, e, f, g, h, i, j, k) {
        ...
        (n.scope = a),
          ...
          (n.single = !0),
          (n.error = ""),
          (n.theme = f[c.editableTheme] || f[h.theme] || f["default"]),
          (n.parent = {}),
          (n.icon_set =
            "default" === h.icon_set
              ? g["default"][h.theme]
          ...
          (n.init = function(b) {
            if (
              ...
              throw "You should provide value for `" +
                n.directiveName +
                "` in editable element!";
          ...
          (n.render = function() {
            ...
            (n.inputEl = angular.element(n.inputTpl)),
              ...
              "no" !== n.buttons &&
                ...
                (n.resetEl = angular.element(a.resetTpl)),
                (n.cancelEl = angular.element(a.cancelTpl)),
                n.submitEl.attr("title", h.submitButtonTitle),
                n.submitEl.attr("aria-label", h.submitButtonAriaLabel),
                n.cancelEl.attr("title", h.cancelButtonTitle),
                n.cancelEl.attr("aria-label", h.cancelButtonAriaLabel),
                n.resetEl.attr("title", h.clearButtonTitle),
                n.resetEl.attr("aria-label", h.clearButtonAriaLabel),
                n.icon_set &&
                  (n.submitEl.find("span").addClass(n.icon_set.ok),
                  n.cancelEl.find("span").addClass(n.icon_set.cancel),
                  n.resetEl.find("span").addClass(n.icon_set.clear)),
                n.buttonsEl.append(n.submitEl).append(n.cancelEl),
                h.displayClearButton && n.buttonsEl.append(n.resetEl),
              ...
              if (!(d.length <= 1)) {
                ...
                if (
                  ...
                  var g = e.substring(0, 1),
                    i = e.substring(1, 2);
                  e =
                    i === i.toUpperCase() && g === g.toUpperCase()
                      ? g.toLowerCase() + "-" + b.camelToDash(e.substring(1))
                      : g.toLowerCase() + b.camelToDash(e.substring(1));
            ...
            n.inputEl.addClass("editable-input"),
              n.inputEl.attr("ng-model", "$parent.$data"),
            ...
            setTimeout(function() {
              ...
              "focus" === h.activate && c.focus
                ? (a &&
                  ...
                  "editableRadiolist" == n.directiveName ||
                  "editableChecklist" == n.directiveName ||
                  "editableBsdate" == n.directiveName ||
                  "editableTagsInput" == n.directiveName
                    ? c.querySelector(".ng-pristine").focus()
                    : c.focus())
                : "select" === h.activate &&
          ...
          link: function(c, f, i, j) {
            ...
            if (j[1]) (k = j[1]), (m = void 0 === i.eSingle);
              ...
              if (n) (k = n), (m = !0);
                ...
                f &&
                "function" == typeof f.parents &&
                f
                  .parents()
                  .last()
                  .find("form[name=" + i.eForm + "]").length
              )
                (k = null), (m = !0);
              else
            ...
            angular.forEach(b, function(a, b) {
              ...
              angular.extend(l, b);
            var p = function() {
              return angular.isDefined(i.editDisabled)
            ...
            if ((l.init(!m), (c.$editable = l), f.addClass("editable"), m))
              ...
              (c.$form = g()),
                c.$form.$addEditable(l),
                i.eForm &&
                  (a(i.eForm).assign || angular.noop)(c.$parent, c.$form),
