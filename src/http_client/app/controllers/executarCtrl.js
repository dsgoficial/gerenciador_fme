(function() {
    ...
    var executarCtrl = function($scope, $uibModal, dataFactory) {
      ...
      $scope.reload = function(){
          dataFactory.getTabelasUltimaVersao()
      ...
      $scope.executa = function(tabela){
        $scope.promise = dataFactory.executar(tabela.id, tabela.paramValues)
          .then(function(resp){
              ...
              var modalAlertInstance = $uibModal.open({
                ...
                resolve: {
                  alert: function () {
                    return {header: 'Sucesso', content: 'Workspace executada com sucesso.', log: resp.log};
                  },
                },
              });
          })
          .catch(function(){
              var modalAlertInstance = $uibModal.open({
                ...
                resolve: {
                  alert: function () {
                    return {header: 'Erro', content: 'Ocorreu um erro enquanto a workspace era executada.'};
                  },
                },
              });
          });
    ...
    angular.module('fmeApp')
        .controller('executarCtrl', executarCtrl);
