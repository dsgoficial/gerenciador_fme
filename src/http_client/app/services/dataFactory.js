(function() {
    ...
    var dataFactory = function($http, $q) {
        ...
        factory.getTabelasVersao = function(){
            return factory.get(urlpath+'versions')
        ...
        factory.getTabelas = function(){
            return factory.get(urlpath+'workspaces')
                .then(function(result){
        ...
        factory.getLogs = function(){
            return factory.get(urlpath+'jobs')
                .then(function(result){
                    factory.logs = result
                })
        };
        ...
        factory.getCategorias = function(){
            return factory.get(urlpath+'categorias')
                .then(function(result){
                    return result
                })
        };
        ...
        factory.getTabelasUltimaVersao = function(){
            return factory.get(urlpath+'versions?last=true')
                .then(function(result){
        ...
        factory.novaVersao = function(workspace, dados){
          ...
          return $http.post(urlpath+'workspaces/'+dados.workspaceid+'/versions', fd, {
              transformRequest: angular.identity,
              headers: {'Content-Type': undefined}
          })
        };
        ...
        factory.executar = function(workspaceid, dados){
            //promise that the data will load
            var q = $q.defer();
            factory.sendJob(workspaceid, dados)
            .then(function(jobid) {
